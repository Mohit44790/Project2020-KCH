	...
	<body>
		<!--start-wrap-->
			...
			<div class="header">
				<div class="wrap">
				<!--start-logo-->
				<div class="logo"><img src="images/logo.png" height="50px" width="50px"><a href="index.html"></a></div>
				<div class="header-name">
					<span>Kidney</span><span1>Care</span1><span2>Hospital</span2><br>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
			...
			<!--start-image-slider---->
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      ...
					      <li><img src="images/slider-image1.jpg" alt=""></li>
					      <li><img src="images/dr.jpg" alt=""></li>
		   ...
		   <footer  id="footer-wrap">			
				<div class="footer-top-container">
					<div class="footer-top-contant">
						<div class="footer-nav"><a href=""><img class="footer-nav-logo" src="images/logo.png"></a></div>
